...
The repository contains the implementation of a library of sampling-based path replanning algorithms and a framework to manage robot trajectory execution with continuous path replanning and collision checking of the current path. It is based on ROS and *MoveIt!* to get information about the environment.
